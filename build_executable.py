#!/usr/bin/env python3
"""
CageMetrics Build Script - Python version
...
def check_dependencies():
    ...
    required_modules = ['PyInstaller', 'PyQt6', 'numpy', 'pandas', 'matplotlib', 'openpyxl']
    missing_modules = []
...
def build_executable():
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            dist_dir = Path(f'dist/CageMetrics_v{version}')
            exe_path = dist_dir / f'CageMetrics_v{version}.exe'
            ...
            if exe_path.exists():
                ...
                zip_path = Path(f'dist/CageMetrics_v{version}_Windows')
                try:
                    shutil.make_archive(str(zip_path), 'zip', 'dist', f'CageMetrics_v{version}')
...
def main():
    """Main build process."""
    print("="*60)
    print("CageMetrics Windows Executable Builder")
    print("="*60)
